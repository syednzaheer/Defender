...
class ForecastResult:
    ...
    model_source: str
    stage_trajectory: list[str] | None = None
...
def score_traffic(features: pd.DataFrame, steps: int = 5) -> ForecastResult:
    ...
    If the trained world-model artifact is later placed in artifacts/models,
    ...
    return ForecastResult(timeline, top_stage, explanations, flagged, "Transparent offline scorer", [top_stage] * horizon)
