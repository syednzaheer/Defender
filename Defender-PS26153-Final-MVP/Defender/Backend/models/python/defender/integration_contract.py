"""Shared contracts for the Defender telemetry integration.
...
# The first 17 fields are the flow features emitted by the
...
def canonicalise_flow_frame(frame: pd.DataFrame) -> tuple[pd.DataFrame, SchemaMetadata]:
...
canonicalise_pipeline_frame = canonicalise_flow_frame
...
def validate_forecast_payload(payload: dict) -> None:
    ...
    required = {"timeline", "stage", "stage_trajectory", "explanations", "flagged_flows", "model_source"}
