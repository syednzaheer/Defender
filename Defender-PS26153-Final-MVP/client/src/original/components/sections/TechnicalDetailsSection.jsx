            ...
            <div style={{ marginTop: '20px' }}>
              ...
              <div style={{ backgroundColor: 'rgba(255,255,255,0.03)', border: '1px solid var(--border-subtle)', borderRadius: '8px', padding: '16px' }}>
                <p style={{ fontFamily: 'var(--font-body)', fontSize: '12px', color: 'var(--text-muted)', margin: 0, lineHeight: 1.5 }}>
                  <strong style={{ color: 'var(--text-secondary)' }}>Note:</strong> This is a local perturbation method. It is not SHAP (SHapley Additive exPlanations) in the formal game-theoretic sense, and the dashboard labels it as feature sensitivity.
                </p>
              </div>
            </div>
          </div>
