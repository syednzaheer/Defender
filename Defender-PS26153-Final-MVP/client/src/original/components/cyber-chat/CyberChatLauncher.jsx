...
export default function CyberChatLauncher({
  ...
  return (
    <div style={{ position: 'fixed', bottom: '24px', right: '24px', zIndex: 500 }}>
      ...
      >
        {open ? <X size={22} /> : (
          <span className="cyper-bot-avatar" aria-hidden="true">
            <span className="cyper-bot-aura" />
            <span className="cyper-bot-head">
              <span className="cyper-bot-visor"><i /><i /></span>
              <span className="cyper-bot-ear cyper-bot-ear-left" />
              <span className="cyper-bot-ear cyper-bot-ear-right" />
            </span>
            <span className="cyper-bot-neck" />
            <span className="cyper-bot-chest"><i /><i /><i /></span>
          </span>
        )}
      </button>
    </div>
