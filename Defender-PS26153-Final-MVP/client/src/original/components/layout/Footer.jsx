    ...
    >
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
          ...
          <div style={{ display: 'flex', gap: '12px' }}>
            <a
              href="https://github.com/syednzaheer/SIH-P.S.-26153-Defender.git"
              target="_blank"
              rel="noreferrer"
      ...
      >
        ...
        <div style={{ display: 'flex', gap: '16px' }}>
          <button type="button" onClick={() => onTabChange && onTabChange('privacy')} style={{ background: 'none', border: 'none', color: 'var(--text-muted)', cursor: 'pointer', fontFamily: 'inherit', fontSize: 'inherit', padding: 0 }}>Privacy Policy</button>
          <button type="button" onClick={() => onTabChange && onTabChange('terms')} style={{ background: 'none', border: 'none', color: 'var(--text-muted)', cursor: 'pointer', fontFamily: 'inherit', fontSize: 'inherit', padding: 0 }}>Terms &amp; Conditions</button>
          <button type="button" onClick={() => onTabChange && onTabChange('cookies')} style={{ background: 'none', border: 'none', color: 'var(--text-muted)', cursor: 'pointer', fontFamily: 'inherit', fontSize: 'inherit', padding: 0 }}>Cookie Policy</button>
        </div>
      </div>
    </footer>
  );
