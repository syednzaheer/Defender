...
const ALIASES = [
  ...
  [/ps\s*26153/gi, 'ps 26153 ntro'],
  [/false\s+positive\s+rate/gi, 'false positive rate fpr'],
  [/netflow\s+vs\s+pcap/gi, 'netflow ipfix pcap'],
  [/pcap\s+vs\s+netflow/gi, 'netflow ipfix pcap'],
  [/ids\s+vs\s+ips/gi, 'ids ips intrusion detection intrusion prevention'],
  [/tcp\s+handshake/gi, 'three way handshake syn ack ack'],
  [/3\s*way\s*handshake/gi, 'three way handshake syn ack ack'],
  [/attribution\s+vs\s+shap/gi, 'shap perturbation attribution'],
];
