...
result = forecast_with_trained_artifact(frame, 'artifacts/cross_day_benchmark/cross_day_world_model_state_dict.pt', 'artifacts/cross_day_benchmark/cross_day_model_config.json', steps=5)
