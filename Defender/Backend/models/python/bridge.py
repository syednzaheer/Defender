...
# PACKAGE_DIR is this file's own directory -- the `defender` package
# lives directly alongside bridge.py now (Backend/models/python/defender/),
# not under a src/ subfolder as before the restructure.
PACKAGE_DIR = Path(__file__).resolve().parent
sys.path.insert(0, str(PACKAGE_DIR))

# ROOT is Backend/models/ -- where artifacts/ lives after the restructure
# (Backend/models/python/bridge.py -> parents[1] == Backend/models/).
