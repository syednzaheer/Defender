...
PACKAGE_DIR = Path(__file__).resolve().parent  # defender/ package lives directly here, no src/ wrapper
sys.path.insert(0, str(PACKAGE_DIR))
ROOT = Path(__file__).resolve().parents[1]  # Backend/models/ -- where artifacts/ actually lives
...
from defender.world_model_adapter import forecast_with_trained_artifact  # noqa: E402
