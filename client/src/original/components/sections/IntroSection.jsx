...
const IntroSection = () => {
  const cards = [
    ...
    },
    {
      ...
      description:
        'Performs rollouts K steps into the future from current observed traffic state S_t. Computes the cumulative infiltration probability timeline and projects the trajectory directly onto MITRE ATT&CK stages (Reconnaissance → Initial Access → Lateral Movement → C2 → Exfiltration) with perturbation-based feature attribution.',
